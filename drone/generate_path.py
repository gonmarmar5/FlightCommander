...
class generate_path_planning():
    def __init__(self, path, algorithm, heuristic, start, goal):
        ...
        if algorithm == 1:
            ...
            if heuristic != 5 and heuristic != 6:
                path, visited = self.astar(graph, start, goal, heuristics[heuristic - 1])
            elif heuristic == 5:
                for heuristic in heuristics:
                    print("The heuristic being used is", heuristic)
        ...
        with open('D:/graph_4.pkl', 'wb') as file:
            pickle.dump(graph, file)

        #with open('D:/path_mid_3.pkl', 'wb') as file:
    ...
    def create_graph(self, image):
        ...
        #            ]
#
        #            # Check if any neighbor is not in the graph
...
if __name__ == '__main__':
    paths = ["D:/Downloads/Maze01-01.png"]
    paths = ["D:/Image.png"]
